...
function Faq() {
  return (
    <div id='faqs' className='p-8 font-sans flex items-center justify-between space-x-10 space-y-4 lg:flex-row flex-col border-b-[1px] border-[#c5c4c4]'>
      <div className='w-full md:w-5/6  lg:w-2/6'>
