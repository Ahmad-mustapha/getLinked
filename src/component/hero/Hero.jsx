  ...
  return (
    <div className='getLinked__hero mt-[6rem] border-b-[1px] border-[#c5c4c4] overflow'>
      ...
      <div className="hero flex lg:flex-row items-start justify-between">
        <div className='col1 lg:w-3/6 w-full pl-0 md:pl-[5rem]'>
        ...
        <div className="lg:w-3/6  md:w-5/6 md:m-auto w-full py-[3rem] px-[.5rem] h-screen overflow-y-hidden flex items-center text-center md:mt-0 mt-[3rem]">
