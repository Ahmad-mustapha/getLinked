...
const Privacy = () => {
  return (
    <div className='py-16 pl-4 md:pl-16 pr-4 font-sans flex flex-col md:flex-row justify-center gap-6'>
      <div className='w-full md:w-3/6'>
        ...
        <div className='p-10 border-[1px] border-[#D434FE] rounded-lg mt-6'>
      ...
      <div className='w-full md:w-3/6 lg:3/6 privacybg'>
