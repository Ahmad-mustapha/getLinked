...
export const Medals = ({medal, position, amount}) =>{
  return(
    <div className='border-[1px] border-[#D434FE] w-[120px] sm:w-[160px] flex flex-col justify-center items-center rounded-lg h-[230px] relative'>
...
const Prizes = () => {
  return (
    // <div className='prizebg p-6 font-sans bg-[#130d24]'>
      ...
      <div className='w-full flex justify-center items-center md:w-2/6'><img src={Award} alt="" /></div>
      <div className='md:w-3/6 lg:w-3/6 p-10 '>
        <div className='mb-[12rem] md:text-left text-center'>
        ...
        <div className='w-full flex flex-col space-y-40 items-center justify-center gap-2 md:gap-2 sm:flex-row sm:flex-nowrap sm:space-y-0'>
