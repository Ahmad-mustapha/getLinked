...
function Intro() {
  ...
  return (
    <div id='overview' className=''>
      ...
      <div className='relative font-sans flex items-center justify-center md:text-left text-center flex-col md:flex-row gap-8 border-b-[1px] border-[#c5c4c4] overflow-x-hidden'>
        <div data-aos="fade-left" className='w-full p-8 md:w-4/6 lg::w-3/6'>
        ...
        <div data-aos="fade-right" className='w-full flex items-center justify-center md:w-3/6'><img src={Rules} alt="" /></div>
      </div>
    </div>
  )
}
